...
export default function Footer() {
    return <footer className="w-full py-16 bg-body text-dark text-center md:px-24 px-7 ">
        <div className={'grid grid-cols-5 md:gap-8'}>
            <div className={'text-start md:col-span-2 flex flex-col justify-between'}>
                ...
                <div className={'mt-8'}>
                    ...
                    <form className={'flex justify-between gap-2 border border-dark rounded-lg py-2 px-3'}>
