...
export default function ProjectManagement() {
    return <section className={'bg-white text-dark py-24 px-7 md:px-24'}>
        <div className={'grid grid-cols-2 gap-24'}>
            <div className={'bg-body rounded-xl m-8 p-8'}>
                <OnlineOrganizer
                    className={'rounded-xl aspect-square object-cover fill-primary w-full'}/>
            </div>
            <div className={'flex flex-col gap-8 justify-center'}>
                <h3 className={'text-7xl font-semibold'}>Simplify Tasks & Project Management</h3>
