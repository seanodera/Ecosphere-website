...
export default function Navbar() {
    ...
    return <div
        className={'flex w-full bg-white md:px-24 px-7 py-4 justify-between text-dark shadow-md fixed top-0 left-0 z-10'}>
        ...
        <ul className={`md:space-x-8 md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-2] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-12' : 'top-[-490px]'}`}>
            {
